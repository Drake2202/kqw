				...
				while ($resultado = mysql_fetch_assoc($query)) {
					...
					echo "
						<tr>
							...
							<td style='border: 1px #000; padding: 10px 50px 10px 50px;' align='center'>$ReqLevel</td>
