				...
				<?php
					if(isset($_POST['add'])){
		                ...
		                <i class='icon-cancel-circle'></i> ID in use!
							...
							if(mysql_query("INSERT INTO meh_items_shops (`id`, `Name`, `Items`, `Staff`, `Upgrade`, `House`, `Limited`) VALUES (NULL, '$nome', '$items', '$staff', '$upgrade', '$house', '$limited')")){
								
								mysql_query("INSERT INTO meh_users_logs (`Staff`, `Info`, `Date`) VALUES ('$user', 'Created the shop: $nome', NOW( ))");
					...
					if(isset($_POST['edd'])){
		                ...
		                <i class='icon-cancel-circle'></i> Fill out all fields!
							...
							if(mysql_query("UPDATE meh_items_shops SET Name='$ed_name', Items='$ed_items', Staff='$ed_staff', Upgrade='$ed_upgrade', House='$ed_house', Limited='$ed_limited' WHERE id='$ed_id'")){
								...
								mysql_query("INSERT INTO meh_users_logs (`Staff`, `Info`, `Date`) VALUES ('$user', 'Edited the shop: $ed_id', NOW( ))");
