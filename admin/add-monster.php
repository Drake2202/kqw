...
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>ASPLIT | Monsters Edit</title>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="monsters.php"><i class="fa fa-circle-o"></i> Monsters</a></li>
  ...
  <div class="content-wrapper">
			...
			<div class="block full">
				...
				<?php
					if(isset($_POST['add'])){
						...
						if(empty($nome) || ($id < 0) || empty($nome) || ($HP <= 0)){
	...
	if(mysql_query("INSERT INTO meh_monsters (`id`, `Name`, `Level`, `HP`, `MP`, `DPS`, `Exp`, `Coins`, `Gold`, `Drops`, `Rep`, `FileName`, `Linkage`) VALUES ($id, '$nome', '$Level', '$HP', '100', '$DPS', '$Exp', '10', '$Gold', '$Drops', '$Rep', '$FileName', '$Linkage')")){
								...
								mysql_query("INSERT INTO meh_users_logs (`Staff`, `Info`, `Date`) VALUES ('$user', 'Created the monster: $nome', NOW( ))");
...
<table>
					<tr>
						<td style='border: 1px #000; padding: 10px 50px 10px 50px;' align="right">id <font color="red" style="font-size: 10px;">(only numbers)</font>:</td><td><input type="text" class="datepicker-trigger form-control hasDatepicker" name="id" value="<?php echo $_POST['id']; ?>"></td>
					</tr>
					...
					if(isset($_POST['edd'])){
		                ...
		                <i class='icon-cancel-circle'></i> Fill out all fields!
							...
							if(mysql_query("UPDATE meh_monsters SET Name='$ed_name', Level='$ed_Level', HP='$ed_HP', DPS='$ed_DPS', Exp='$ed_Exp', Gold='$ed_Gold', Drops='$ed_Drops', Rep='$ed_Rep', FileName='$ed_FileName', Linkage='$ed_Linkage' WHERE id='$ed_id'")){
								...
								mysql_query("INSERT INTO meh_users_logs (`Staff`, `Info`, `Date`) VALUES ('$user', 'Edited the monster: $ed_id', NOW( ))");
