      ...
      <div class="box">
        ...
        <div class="box-body">
		  ...
		  <!-- Recent activity -->
			...
			<div class="block">
				<h6 class="heading-hr"><i class="icon-file"></i> Players online</h6>
				<ul class="media-list">
				</ul>
        	</div>				<br />
				<?php
					...
					if(mysql_num_rows($busca_all_on) <= 0){
		                ...
		                <i class='icon-cancel-circle'></i> Bad server: 0 players online
		            </div>";					}else{
				?>
					...
					<table>
						<tr>
							...
							<td style='border: 1px #000; padding: 10px 50px 10px 50px;' align='center'><b>Rank</b></td>
						</tr>
						<?php 
			...
			<div class="block">
				<h6 class="heading-hr"><i class="icon-file"></i> Staff members</h6>
				<ul class="media-list">
				</ul>
        	</div>						<br />
				<?php
					...
					if(mysql_num_rows($busca_all_on) <= 0){
							echo "<div class='alert alert-danger fade in block-inner'>
		                <i class='icon-cancel-circle'></i>Do not have staff players.
		            </div>";		
					}else{
				?>
						...
						<?php 
							while($fetch_all = mysql_fetch_array($busca_all_on)){
								...
								if($fetch_all[4] > 40)
									...
									$cargo = "<font color='green'>Moderator</font>";
			...
			<div class="block">
				<h6 class="heading-hr"><i class="icon-file"></i> Banned players</h6>
				<ul class="media-list">
				</ul>
        	</div>
				<?php
					...
					if(mysql_num_rows($busca_all_on) <= 0){
							echo "<div class='alert alert-danger fade in block-inner'>
		                <i class='icon-cancel-circle'></i>Do not exist banned players.
		            </div>";						}else{
				?>
			...
			<?php }else{ ?>
		                ...
		                <i class='icon-cancel-circle'></i>Nothing to be listed.
		            </div>
		            <?php } ?>
